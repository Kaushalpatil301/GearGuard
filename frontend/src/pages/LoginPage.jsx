      ...
      <div className="relative max-w-lg w-full space-y-10 p-10">
          ...
          <form className="space-y-8" onSubmit={handleSubmit}>
            ...
            <div className="flex items-center justify-between text-base">
              <label className="flex items-center text-gray-400 font-medium">
                <input type="checkbox" className="mr-3 h-5 w-5 text-gray-100 focus:ring-gray-400/50 rounded" />
                Remember me
              </label>
              <a href="#" className="text-gray-300 hover:text-gray-100 transition-colors duration-300 font-medium">
                Forgot password?
              </a>
            </div>
        ...
        <div className="text-center">
          <p className="text-base text-gray-500">
            ...
            <Link to="/signup" className="text-gray-300 hover:text-gray-100 transition-colors duration-300 font-medium">
              Sign up
            </Link>
          </p>
        </div>
